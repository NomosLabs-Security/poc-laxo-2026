# LAXO — Flawed Burn Mechanism Price Manipulation — PoC
...
```bash
git clone https://github.com/NomosLabs-Security/poc-laxo-2026
cd poc-laxo-2026
...
- **Fork Block:** #82730140 (one block before attack)
- **Expected Output:** ~$137K profit via burn-triggered price manipulation
- **Full Analysis:** [NomosLabs Security Intelligence Archive](https://nomoslabs.io/archive/laxo-2026)
